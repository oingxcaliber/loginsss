...
class ConfirmScreen extends StatefulWidget {
  ...
  int sum;
  ConfirmScreen(this.lisen, this.detail, this.offense, this.place, this.sum,this.password);
...
class _ConfirmScreen extends State<ConfirmScreen> {
  ...
  _ConfirmScreen(this.lisen, this.detail, this.offense, this.place, this.sum,this.password);
  @override
        ...
        child: Column(
          children: <Widget>[
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: <Widget>[
                Text('ข้อหาที่กระทำผิด : ' + this.offense,
                    style:
                        TextStyle(fontSize: 15.0, fontWeight: FontWeight.bold)),
              ],
            ),
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: <Widget>[
                Text('รวมที่ต่องจ่าย : ' + this.sum.toString(),
                    style:
                        TextStyle(fontSize: 15.0, fontWeight: FontWeight.bold)),
              ],
            ),
